...
echo ""
echo "─── Syncing EarthRanger credentials (per-tenant — stored in DB, not env) ───"
echo "  ℹ️  EarthRanger credentials are per-tenant and stored encrypted in the database."
echo "  ℹ️  They are NOT synced to .env files. Configure via tenant settings UI."
