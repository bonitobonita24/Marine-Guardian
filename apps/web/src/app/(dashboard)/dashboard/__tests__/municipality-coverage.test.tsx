...
describe("MunicipalityCoverageChart", () => {
  ...
  it("renders the Recharts container when data is present", () => {
    render(<MunicipalityCoverageChart data={data} isLoading={false} />);
    expect(
  ...
  it("shows a loading message while loading", () => {
    render(<MunicipalityCoverageChart data={[]} isLoading={true} />);
    expect(screen.getByText(/loading/i)).toBeTruthy();
  });

  it("shows empty state when data is empty and not loading", () => {
    render(<MunicipalityCoverageChart data={[]} isLoading={false} />);
