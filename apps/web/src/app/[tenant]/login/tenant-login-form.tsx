...
// Cloned from app/login/page.tsx (LoginForm) with the tenant binding added:
// `tenant` (the URL slug) is submitted as `tenantSlug` in the credentials POST,
// and the default post-login destination is this tenant's dashboard.
export function TenantLoginForm({ tenant }: { tenant: string }) {
